...
class FreeIpTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = FreeIpTestRunner.getenv("FREEIP_TEST_LIVE")
        override = FreeIpTestRunner.getenv("FREEIP_TEST_OVERRIDE")
        ...
        explain = FreeIpTestRunner.getenv("FREEIP_TEST_EXPLAIN")
        if explain is not None and explain != "":
            m["FREEIP_TEST_EXPLAIN"] = explain
