# FreeIp SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions FreeIpSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both FreeIpSDK(...) and FreeIpSDK.test(...) become
#      FreeIpSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "freeip_sdk"
_SDK_CLASS = "FreeIpSDK"
