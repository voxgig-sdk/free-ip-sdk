...
(0, node_test_1.describe)('JsonEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != json_ref01_data.id);
        // LIST
        const json_ref01_match = {};
        const json_ref01_list = (await json_ref01_ent.list(json_ref01_match)).map((e) => e.data());
        (0, node_assert_1.default)(!isempty(select(json_ref01_list, { id: json_ref01_data.id })));
        // LOAD
...
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['FREE_IP_TEST_JSON_ENTID'];
