...
(0, node_test_1.describe)('IpGeolocationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-ip_geolocation', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-ip_geolocation', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.FREE_IP_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.FreeIpSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['FREE_IP_TEST_IP_GEOLOCATION_ENTID'];
    ...
    const client = new __1.FreeIpSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=IpGeolocationDirect.test.js.map