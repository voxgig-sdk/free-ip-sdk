...
type Args struct {
	Entity string         `json:"entity" jsonschema:"ip_geolocation | json"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.FreeIpSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "free-ip_list",
		Description: "List records from FreeIp. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "free-ip_load",
		Description: "Load a single record from FreeIp. " +
...
func runOp(client *sdk.FreeIpSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.FreeIpSDK, name string) (sdk.FreeIpEntity, error) {
	switch strings.ToLower(name) {
	case "ip_geolocation":
		return client.IpGeolocation(nil), nil
	case "json":
