...
func registerSDKWords(r *eng.Registry, client *sdk.FreeIpSDK) {
...
func runOp(client *sdk.FreeIpSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
