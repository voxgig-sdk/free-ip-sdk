...
class FreeIpTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = FreeIpTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = FreeIpTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = FreeIpTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
