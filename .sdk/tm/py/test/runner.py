...
class FreeIpTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = FreeIpTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = FreeIpTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = FreeIpTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
