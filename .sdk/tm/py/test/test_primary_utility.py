...
from projectname_sdk import FreeIpSDK
from projectname_sdk.core.spec import FreeIpSpec
from projectname_sdk.core.result import FreeIpResult
from projectname_sdk.core.response import FreeIpResponse
from projectname_sdk.core.operation import FreeIpOperation
from projectname_sdk.core.error import FreeIpError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import FreeIpBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = FreeIpSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = FreeIpSDK.test(None, None)
        ...
        class TestInitFeature(FreeIpBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(FreeIpBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = FreeIpSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = FreeIpSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = FreeIpSDK.test(None, setup_opts)
