...
from projectname_sdk.core.control import FreeIpControl
...
class FreeIpContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, FreeIpResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return FreeIpError(code, msg, self)
