...
// FreeIp SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class FreeIpMakeRequest
{
    public static function call(FreeIpContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new FreeIpResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new FreeIpResponse($fetched);
        } else {
