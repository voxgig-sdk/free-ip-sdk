...
|---|---|---|
| `ts/` | @voxgig-sdk/free-ip-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/free-ip-sdk \
      --repository voxgig-sdk/free-ip-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/free-ip-sdk` shows it, and
`npm trust revoke @voxgig-sdk/free-ip-sdk --id=<id>` removes it.
