...
class JsonEntity
  ...
  # @return [Json, Hash] the loaded Json; raises FreeIpError on failure
  ...
  #
  # @param reqmatch [JsonListMatch, Hash, nil] match filter (any subset of
  #   Json fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Json>, Array] the matching Json items; raises FreeIpError on failure
  ...
  # Create a new Json.
  #
  # @param reqdata [JsonCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Json, Hash] the created Json; raises FreeIpError on failure
