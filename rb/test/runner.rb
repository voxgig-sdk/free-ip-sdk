...
module FreeIpTestRunner
  ...
  def self.env_override(m)
    live = getenv("FREEIP_TEST_LIVE")
    override = getenv("FREEIP_TEST_OVERRIDE")
    ...
    explain = getenv("FREEIP_TEST_EXPLAIN")
    m["FREEIP_TEST_EXPLAIN"] = explain if explain && !explain.empty?
