...
class FreeIpFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; FreeIpSDK/1.0)';
    ...
    public static function call(FreeIpContext $ctx, string $fullurl, array $fetchdef): array
    {
