...
class FreeIpTestRunner
{
    ...
    {
        $live = self::getenv('FREE_IP_TEST_LIVE');
        $override = self::getenv('FREE_IP_TEST_OVERRIDE');
        ...
        $explain = self::getenv('FREE_IP_TEST_EXPLAIN');
...
class_alias('FreeIpTestRunner', 'Runner');
class_alias('FreeIpHelpers', 'Helpers');
