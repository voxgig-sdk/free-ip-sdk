...
// FreeIp SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (FreeIpSDK::test)
...
{
    private const SDK_CLASS = 'FreeIpSDK';
    ...
    private const SDK_BASE = 'freeip_sdk';
