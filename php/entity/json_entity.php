...
class JsonEntity
{
    ...
    /**
     * List Json items matching the given filter.
     *
     * @param JsonListMatch|array|null $reqmatch Match filter (any subset
     *   of Json fields) as an assoc-array; JsonListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Json[]|array A list of Json items as assoc-arrays at
     *   the SDK boundary; throws FreeIpError on failure (item-5 convention).
     */
     ...
     * Create a new Json.
     *
     * @param JsonCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed JsonCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Json|array The created Json as an assoc-array at the
     *   SDK boundary; throws FreeIpError on failure (item-5 convention).
     */
