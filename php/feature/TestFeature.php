...
// FreeIp SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class FreeIpTestFeature extends FreeIpBaseFeature
{
    ...
    public function init(FreeIpContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (FreeIpContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (FreeIpContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(FreeIpContext $ctx, $op, $args): array
    {
