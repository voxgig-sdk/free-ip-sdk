...
// FreeIp SDK clienttrack feature
...
class FreeIpClienttrackFeature extends FreeIpBaseFeature
{
    ...
    public function PostConstruct(FreeIpContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'FreeIp-SDK';
