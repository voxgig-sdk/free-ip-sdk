...
class FreeIpTimeoutFeature extends FreeIpBaseFeature
{
    ...
    private function _with_timeout(FreeIpContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(FreeIpContext $_ctx, float $ms): void
    {
        $client = $this->client;
