...
class FreeIpRatelimitFeature extends FreeIpBaseFeature
{
    ...
    private function _acquire(FreeIpContext $ctx): void
    {
    ...
    private function _track(FreeIpContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
