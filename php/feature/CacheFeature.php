...
class FreeIpCacheFeature extends FreeIpBaseFeature
{
    ...
    private function _through(FreeIpContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
