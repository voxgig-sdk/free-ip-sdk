...
class FreeIpStreamingFeature extends FreeIpBaseFeature
{
    ...
    private function _iterate(FreeIpResult $result): \Generator
    {
    ...
    private function _streamable(FreeIpContext $ctx): bool
    {
