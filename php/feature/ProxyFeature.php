...
class FreeIpProxyFeature extends FreeIpBaseFeature
{
    ...
    public function init(FreeIpContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (FreeIpContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
