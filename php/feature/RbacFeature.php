...
class FreeIpRbacFeature extends FreeIpBaseFeature
{
    ...
    private function _required(FreeIpContext $ctx): ?string
    {
    ...
    private function _reject(FreeIpContext $ctx, string $required): void
    {
    ...
    private function _track(FreeIpContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
