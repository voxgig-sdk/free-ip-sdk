...
const testSeed = `map[string]any{"entity": map[string]any{"ip_geolocation": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "json": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
