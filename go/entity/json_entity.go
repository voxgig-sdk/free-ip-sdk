...
func NewJsonEntity(client *core.FreeIpSDK, entopts map[string]any) *JsonEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *JsonEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// JsonListMatch and returns []Json. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *JsonEntity) ListTyped(reqmatch JsonListMatch, ctrl map[string]any) ([]Json, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Json](res), nil
}




func (e *JsonEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// JsonCreateData and returns an Json. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *JsonEntity) CreateTyped(reqdata JsonCreateData, ctrl map[string]any) (Json, error) {
