...
type IpGeolocationEntity struct {
	name    string
	client  *core.FreeIpSDK
...
func NewIpGeolocationEntity(client *core.FreeIpSDK, entopts map[string]any) *IpGeolocationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *IpGeolocationEntity) GetName() string { return e.name }
...
func (e *IpGeolocationEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *IpGeolocationEntity) Deleted() bool {
	return e.deleted
}


func (e *IpGeolocationEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewIpGeolocationEntity(e.client, opts)
}

func (e *IpGeolocationEntity) Data(args ...any) any {
...
func (e *IpGeolocationEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an IpGeolocation; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *IpGeolocationEntity) DataTyped(data ...IpGeolocation) IpGeolocation {
	if len(data) > 0 {
		return typedFrom[IpGeolocation](e.Data(asMap(data[0])))
	}
	return typedFrom[IpGeolocation](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through IpGeolocation (all fields
// optional at the wire level).
func (e *IpGeolocationEntity) MatchTyped(match ...IpGeolocation) IpGeolocation {
	if len(match) > 0 {
		return typedFrom[IpGeolocation](e.Match(asMap(match[0])))
	}
	return typedFrom[IpGeolocation](e.Match())
}
...
func (e *IpGeolocationEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *IpGeolocationEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// IpGeolocationLoadMatch and returns an IpGeolocation. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *IpGeolocationEntity) LoadTyped(reqmatch IpGeolocationLoadMatch, ctrl map[string]any) (IpGeolocation, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return IpGeolocation{}, err
	}
	return typedFrom[IpGeolocation](res), nil
}



func (e *IpGeolocationEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *IpGeolocationEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *IpGeolocationEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *IpGeolocationEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *IpGeolocationEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
