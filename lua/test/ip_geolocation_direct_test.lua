...
describe("IpGeolocationDirect", function()
  it("should direct-load-ip_geolocation", function()
    local setup = ip_geolocation_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-ip_geolocation", setup.live and "live" or "unit")
