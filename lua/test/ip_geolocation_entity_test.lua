...
describe("IpGeolocationEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set FREEIP_TEST_IP_GEOLOCATION_ENTID JSON to run live")
      return
    end
...
function ip_geolocation_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("FREEIP_TEST_IP_GEOLOCATION_ENTID")
