...
describe("JsonDirect", function()
  it("should direct-list-json", function()
    local setup = json_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-json", setup.live and "live" or "unit")
